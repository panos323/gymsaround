     ...
     <div class="footerrow"></div>   
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6 mb-4" id="footerextra">
                ...
                <p><a href="<?php echo URLROOT; ?>/pages/privacypolicy">Πολιτική Απορρήτου</a></p>
            ...
            <div class="col-lg-2 col-md-4 col-sm-12 mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 offset-md-0 col-sm-6 offset-sm-3">
                         <a class="btn btn-outline-warning" id="btnfooter" href="<?php echo URLROOT; ?>/owners/index"> Γίνε συνεργάτης</a>
                   </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-12 col-12 mb-4">
...
<script src ="<?php echo URLROOT; ?>/js/customLightbox.js"/></script>
</body>
</html>